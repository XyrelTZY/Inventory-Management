    ...
    render(){
      return(
        <div className = 'ProductCard'>
          <p className='category'>Items &#187; {this.state.category}</p>
  ...
  const Sidebar = (props) => {
    return(
      <div className='Sidebar'>
        <ul>
          <li className='add-new-item' onClick={() => props.changeTab(0)}><span>Add</span></li>
          <li className={props.activeTab == 1 ? 'active':''} onClick={() => props.changeTab(1)}>Items</li>
          <li className={props.activeTab == 2 ? 'active':''} onClick={() => props.changeTab(2)}>Contach</li>
          <li className={props.activeTab == 3 ? 'active':''} onClick={() => props.changeTab(3)}>Other's</li>
        </ul>
      </div>
    );
  }
    ...
    render(){
      return(
        <div className='InventoryManagementApp'>
          <h2 className='header'><i className="icon-th-list"></i> Inventory</h2>
          <h1 className='title' onClick={() => this.changeActiveTab(1)}>&copy;XYREL D. TENEFRANCIA</h1>
